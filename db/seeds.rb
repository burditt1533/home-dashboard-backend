...
songs = [
    {
        ...
        tempo: 79,
        lyrics: File.read('db/lyrics/what-was-i-made-for.json'),
        song_url: 'what-was-i-made-for.mp3'
    },
    {
        name: 'Fire Lovin',
        artist: 'Pleasure P',
        tempo: 79,
        lyrics: File.read('db/lyrics/fire-lovin.json'),
        song_url: 'fire-lovin.mp3'
    },
    {
        name: 'ICU',
        artist: 'Coco Jones',
        tempo: 79,
        lyrics: File.read('db/lyrics/icu.json'),
        song_url: 'icu.mp3'
    },
    {
        name: 'All I Ask',
        artist: 'Adele',
        tempo: 71,
        lyrics: File.read('db/lyrics/all-i-ask.json'),
        song_url: 'all-i-ask.mp3'
    },
    {
        name: 'On The Side',
        artist: 'Usher',
        tempo: 79,
        lyrics: File.read('db/lyrics/on-the-side.json'),
        song_url: 'on-the-side.mp3'
    },
]
